...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a35zyroajq2p1c.iot.us-west-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "testBBB" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		"testBBB" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "rootCATest.crt" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "34f81648fe-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "34f81648fe-private.pem.key" ///< Device private key filename
// =================================================
