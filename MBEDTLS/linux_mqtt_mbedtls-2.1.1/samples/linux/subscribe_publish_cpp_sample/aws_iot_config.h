...
#define AWS_IOT_MQTT_CLIENT_ID         "123456789b" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "BeagleBone" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "rootCA.crt" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "16e199f99b-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "16e199f99b-private.pem.key" ///< Device private key filename
// =================================================
